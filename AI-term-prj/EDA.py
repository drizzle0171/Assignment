...
nonsan = pd.read_csv('/nas/home/drizzle0171/AI-term-prj/dataset/TRAIN/논산.csv', index_col=False)
nonsan_aws = pd.read_csv('/nas/home/drizzle0171/AI-term-prj/dataset/TRAIN_AWS/논산.csv', index_col=False)
...
aws = pd.read_csv('./dataset/META/awsmap.csv', index_col=False)
pm = pd.read_csv('./dataset/META/pmmap.csv', index_col=False)
